...
val backgroundLight = Color(0xFFFCF6F2) //background color
val onBackgroundLight = Color(0xFF231917)
val surfaceLight = Color(0xFFFFF8F6) //changes card color - secondary?
val onSurfaceLight = Color(0xFF231917)
val surfaceVariantLight = Color(0xFFF5DED8) //changes card color - main
